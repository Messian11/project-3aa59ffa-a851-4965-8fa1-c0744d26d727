...
add_action('acf/init', function () {
    ...
    acf_add_local_field_group([
        ...
        'fields' => [
            ...
            [
                'key' => 'field_mfo_all_russia',
                'label' => 'Работает по всей России',
                'name' => 'mfo_all_russia',
                'type' => 'true_false',
                'instructions' => 'Если включено — МФО автоматически показывается на страницах ВСЕХ городов, не нужно отмечать города вручную.',
                'ui' => 1,
                'default_value' => 1,
            ],
            [
                'key' => 'field_mfo_features',
                'label' => 'Особенности (для фильтра)',
                'name' => 'mfo_features',
                'type' => 'checkbox',
                'instructions' => 'Используется в фильтре каталога.',
                'choices' => [
